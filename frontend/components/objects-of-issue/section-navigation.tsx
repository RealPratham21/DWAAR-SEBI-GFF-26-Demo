...
export function ObjectsOfIssueSectionNavigation({
  activeSection,
  progress,
  dirtySections,
  onSelect,
  ...
  onSelect: (section: ObjectsOfIssueSectionId) => void;
}) {
  return (
    <nav aria-label="Objects of the Issue information sections" className="space-y-1">
      {OBJECTS_OF_ISSUE_INFORMATION_SECTIONS.map((section) => {
