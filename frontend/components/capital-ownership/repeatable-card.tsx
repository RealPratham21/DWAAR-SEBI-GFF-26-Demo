...
/**
 * A single repeatable record. Removing a row that already carries data asks for confirmation,
 * because these rows feed the derived cap table and reconciliation checks.
 */
...
/** `true` when any tracked field on a repeatable row carries a value. */
