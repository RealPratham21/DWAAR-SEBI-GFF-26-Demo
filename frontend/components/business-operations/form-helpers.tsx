...
import { YES_NO_NOT_SURE_OPTIONS } from '@/lib/business-operations/options';
import type { AmountUnit } from '@/lib/capital-ownership/types';
import type { YesNoNotSureOrEmpty } from '@/lib/business-operations/types';

const yesNoNotSureOptions = YES_NO_NOT_SURE_OPTIONS;

export { CheckboxField, ComputedStat, SelectField, TextInputField };

/** Two-column responsive grid used by every Business & Operations form block. */
...
/**
 * B1 session-only persistence notice. Shown once near section actions when useful.
 */
export function SessionNotice() {
  return (
    ...
    >
      Changes are kept for this browser session only. Permanent saving will be connected in B2.
    </p>
  );
}
