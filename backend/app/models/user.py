...
class User(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    management_governance_workspace: Mapped["ManagementGovernanceWorkspace | None"] = relationship(
        back_populates="user",
        cascade="all, delete-orphan",
        uselist=False,
    )
    industry_market_workspace: Mapped["IndustryMarketWorkspace | None"] = relationship(
        back_populates="user",
        cascade="all, delete-orphan",
        uselist=False,
    )
    group_entities_related_parties_workspace: Mapped[
    ...
    borrowings_assets_contracts_workspace: Mapped[
    ...
    litigation_approvals_compliance_workspace: Mapped[
    ...
    intermediaries_filing_workspace: Mapped[
...
if TYPE_CHECKING:
    ...
    from app.models.litigation_approvals_compliance_workspace import (
        LitigationApprovalsComplianceWorkspace,
    )
    from app.models.group_entities_related_parties_workspace import (
