"""Group Entities & Related Parties workspace model — one row per user."""
...
class GroupEntitiesRelatedPartiesWorkspace(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    __tablename__ = "group_entities_related_parties_workspaces"
    __table_args__ = (
        Index(
    ...
    user: Mapped["User"] = relationship(back_populates="group_entities_related_parties_workspace")
