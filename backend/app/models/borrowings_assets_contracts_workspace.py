"""Borrowings, Assets & Contracts workspace model — one row per user."""
...
class BorrowingsAssetsContractsWorkspace(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    __tablename__ = "borrowings_assets_contracts_workspaces"
    __table_args__ = (
        Index(
    ...
    user: Mapped["User"] = relationship(back_populates="borrowings_assets_contracts_workspace")
